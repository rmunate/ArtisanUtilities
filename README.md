...
ARTISAN_UTILITIES_NOTIFICATION = true #-- Define si se debe notificar por correo en cada actualización por defecto la librería NO notifica.
...
ARTISAN_UTILITIES_NOTIFICATION_COPYRIGHT_YEAR = '2023' #-- Año del Copyright.
